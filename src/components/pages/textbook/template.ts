    ...
    <div class="textbook__container">
      ...
      <div class="textbook__content">
        <ul class="textbook__list">
          ...
          <li class="textbook__item textbook__item-a2">
          ...
          <li class="textbook__item textbook__item-b1">
            <a class="textbook__link" href="#">
          ...
          <li class="textbook__item textbook__item-b2">
            <a class="textbook__link" href="#">
          ...
          <li class="textbook__item textbook__item-c1">
            <a class="textbook__link" href="#">
          ...
          <li class="textbook__item textbook__item-c2">
            <a class="textbook__link" href="#">
