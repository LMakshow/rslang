        ...
        <div class="team__content">
            <div class="team__cards">
                <div class="team__card">
                    ...
                    <img class="team__img" src="assets/images/team/photo.png" alt="Name">
                    <a class="team__link" href="https://github.com/adypr">adypr</a>
                    <div class="team__cloud">
                        Чем только не занимался в жизни! Инжиниринг, дизайн, фотография, танцы, и вот теперь изучаю программирование и хочу свитчнуться в новую интересную профессию!
                    </div>
                    <p class="team__description">С первого же дня разработки взялась за бэкенд и взялась так успешно, что они ни разу не упал за все время работы над проектом! </p>
                </div>
